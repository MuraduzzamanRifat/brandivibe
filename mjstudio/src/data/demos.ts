...
export const demos: Demo[] = [
  ...
  },
  {
    num: "13",
    name: "Octane",
    category: "Music · Interactive Campaign Destination",
    description:
      "A WebGL world-building campaign destination — not a landing page, an experience you climb. Boot-sequence intro that establishes connection and locks coordinates, a 'terrain-grid pulse' mountain hero (sonar waves traveling over a wireframe mesh), non-traditional HUD navigation with a pinned ascent index, an 11-track record sequenced as altitudes, a live channel, and a multi-platform pre-save funnel. Near-black + warm-tan palette, Anton display type.",
    tags: ["Next.js", "R3F", "Terrain pulse shader", "Campaign destination"],
    href: "/octane",
    kind: "website",
    video: null,
    poster: null,
    gradient: "from-[#c4b49a]/22 via-[#d98a4a]/8 to-[#0a0908]",
    year: "2026",
    role: "Design · Build · WebGL",
  },
];
