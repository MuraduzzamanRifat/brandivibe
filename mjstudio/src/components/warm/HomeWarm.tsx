...
const REASSURE = [
  { icon: Heart, title: "A senior team who cares", body: "You work with people who do the actual work — no juniors, no hand-offs, no call centre." },
  { icon: Clock, title: "Quick, and kept in the loop", body: "We move fast, share progress as we go, and reply within a day. No black boxes." },
  { icon: KeyRound, title: "You own everything", body: "Your code, your accounts, your files. We build it to be yours — never locked in." },
];

const STEPS = [
  { n: "01", title: "Say hello", body: "Tell us what you're hoping to do. A friendly chat, no pressure, no jargon — just working out if we're a good fit." },
  { n: "02", title: "Make a plan", body: "We map the goal, the shape of the work, and a clear price. You'll know exactly what you're getting before we start." },
  { n: "03", title: "Build it together", body: "We do the work in close contact, sharing progress often so it always feels like yours, right up to launch." },
  { n: "04", title: "Launch & look after", body: "We ship it properly, show you how everything works, and stick around to help it grow." },
];
    ...
    <>
      ...
      <section className="relative pt-36 pb-20 md:pt-44 md:pb-28 px-5 sm:px-8 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1200px]">
          ...
          >
            Everything your business needs to grow online, <span className="gradient-text">under one warm roof</span>.
          </motion.h1>
          <motion.p
            {...rise}
        ...
        <div className="mx-auto max-w-[1200px]">
          <motion.div {...rise} className="max-w-[46ch]">
            ...
            <h2 className="mt-4 font-display text-4xl md:text-[3.2rem] font-semibold tracking-tight text-balance">
              Six ways we help, one team to call.
            </h2>
          ...
          <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {pillars.map((p, i) => {
              const count = getServicesByPillar(p.title).length;
              return (
      ...
      <section className="px-5 sm:px-8 py-24 md:py-28 bg-surface-2 border-y border-border">
        <div className="mx-auto max-w-[1200px]">
          <motion.div {...rise} className="max-w-[46ch]">
            <p className="font-mono text-xs uppercase tracking-[0.18em] text-primary">— How it works</p>
            <h2 className="mt-4 font-display text-4xl md:text-[3.2rem] font-semibold tracking-tight text-balance">
              Working together feels easy.
            </h2>
          </motion.div>
          <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {STEPS.map((s, i) => (
              <motion.div key={s.n} {...rise} transition={{ ...rise.transition, delay: (i % 4) * 0.06 }} className="card-soft p-6">
