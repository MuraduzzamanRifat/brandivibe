...
Generated by Brandivibe — brandivibe.com

===============================================

DESIGN SCORE: ${research.currentDesignScore}/10
INDUSTRY READ: ${research.industryName}
TECH STACK: ${research.techStackSummary}
...
FULL WEAKNESS LIST
${research.realWeaknesses.map((w, i) => `${i + 1}. ${w}`).join("\n")}

===============================================

If any of this is useful, reply to this email and I'll walk you
through it on a 15-min call. No slides, no pitch deck.
